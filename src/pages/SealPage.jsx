...
import seal1 from "../assets/seal/1.jpg";
import seal2 from "../assets/seal/2.jpg";

export default function sealpage() {
  const [activeImage, setActiveImage] = useState(seal1);
          ...
          <div className="sm:w-1/2 px-2">
                ...
                <div className="bg-white rounded-xl shadow-md p-4 sm:p-10 w-full overflow-x-auto">
                    ...
                    <tbody className="text-center">
                        ...
                        <td className="py-3 px-4 font-medium"> SEAL PREMIUM</td>
                        <td className="py-3 px-4 font-semibold">639.000.000</td>
                        <td className="py-3 px-4 text-gray-500">650 km</td>
                        </tr>
                        <tr className="border-b">
                        <td className="py-3 px-4 font-medium">SEAL PERFORMANCE</td>
                        <td className="py-3 px-4 font-semibold">750.000.000</td>
                        <td className="py-3 px-4 text-gray-500">580 km</td>
                        </tr>
                    </tbody>
                    </table>
                </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8 max-w-7xl mx-auto">
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <p className="text-sm sm:text-base mb-6">
                Tertarik dengan BYD Seal? Hubungi{" "}
                <strong>Khadafi Rafsanjani</strong> untuk info lebih lanjut atau
                jadwalkan test drive!
              </p>
              <a
                href="https://wa.me/62811931804?text=Halo,%20saya%20tertarik%20dengan%20BYD%20Seal%20%F0%9F%9A%97"
                target="_blank"
