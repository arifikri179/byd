...
import a1 from "../assets/atto/1.jpg";
import a2 from "../assets/atto/2.jpg";
    ...
    <table className="w-full text-xs sm:text-base text-gray-700 border-collapse">
      ...
      <tbody className="text-center">
        <tr className="border-b">
          <td className="py-3 px-4 font-medium"> ATTO 3 ADVANCED</td>
          <td className="py-3 px-4 font-semibold">390.000.000</td>
          <td className="py-3 px-4 text-gray-500">410 km</td>
        </tr>
        <tr className="border-b">
          <td className="py-3 px-4 font-medium">ATTO 3 SUPERIOR</td>
          <td className="py-3 px-4 font-semibold">520.000.000</td>
          <td className="py-3 px-4 text-gray-500">480 km</td>
        </tr>
      </tbody>
    </table>
  </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8 max-w-7xl mx-auto">
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <p className="text-sm sm:text-base mb-6">
                Tertarik dengan BYD Atto 3? Hubungi{" "}
                <strong>Khadafi Rafsanjani</strong> untuk info lebih lanjut atau
                jadwalkan test drive!
              </p>
              <a
                href="https://wa.me/62811931804?text=Halo,%20saya%20tertarik%20dengan%20BYD%20Atto 3%20%F0%9F%9A%97"
                target="_blank"
