...
import sealionImage1 from "../assets/sealion/1.jpg";
import sealionImage2 from "../assets/sealion/2.jpg";
import sealionImage3 from "../assets/sealion/3.jpg";
import sealionImage4 from "../assets/sealion/4.jpg";
import sealionImage5 from "../assets/sealion/5.jpg";
import sealionImage6 from "../assets/sealion/6.jpg";
import sealionImage7 from "../assets/sealion/7.jpg";
import sealionImage8 from "../assets/sealion/9.jpg";
import sealionImage9 from "../assets/sealion/10.jpg";
export default function SealionPage() {
  const [activeImage, setActiveImage] = useState(sealionImage1);
      ...
      <main className="flex-grow">
        ...
        <section className="max-w-7xl mx-auto px-5 sm:px-6 py-12 sm:py-16 flex flex-col sm:flex-row justify-between items-center mt-10">
          ...
          <div className="sm:w-1/2 px-2">
            ...
            <div className="bg-white rounded-xl shadow-md p-4 sm:p-10 w-full overflow-x-auto">
            <h3 className="text-sm sm:text-lg font-bold text-gray-800 mb-4 text-center">
                Varian & Jarak Tempuh
            </h3>
            <table className="w-full text-xs sm:text-base text-gray-700 border-collapse">
                ...
                <tr className="border-b text-gray-900 font-semibold text-center">
                    <th className="py-1 sm:py-2 px-2 sm:px-4">Varian</th>
                    <th className="py-1 sm:py-2 px-2 sm:px-4">Harga (Rp)</th>
                    <th className="py-1 sm:py-2 px-2 sm:px-4">Jarak Tempuh</th>
                </tr>
                </thead>
                <tbody className="text-center">
                <tr className="border-b">
                    <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium">SEALION 7 PREMIUM</td>
                    <td className="py-2 sm:py-3 px-2 sm:px-4 font-semibold">629.000.000</td>
                    <td className="py-2 sm:py-3 px-2 sm:px-4 text-gray-500">567 km</td>
                </tr>
                <tr className="border-b">
                    <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium">SEALION 7 PERFORMANCE</td>
                    <td className="py-2 sm:py-3 px-2 sm:px-4 font-semibold">719.000.000</td>
                    <td className="py-2 sm:py-3 px-2 sm:px-4 text-gray-500">542 km</td>
                </tr>
                </tbody>
            </table>
            </div>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-8 max-w-7xl mx-auto">
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              ...
              <p className="text-sm sm:text-base mb-6">
                Tertarik dengan BYD Sealion? Hubungi{" "}
                <strong>Khadafi Rafsanjani</strong> untuk info lebih lanjut atau
                jadwalkan test drive!
              </p>
              <a
                href="https://wa.me/62811931804?text=Halo,%20saya%20tertarik%20dengan%20BYD%20Sealion%20%F0%9F%9A%97"
                target="_blank"
